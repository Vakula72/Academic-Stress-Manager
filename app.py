...
from priority_engine import explain_priority, priority_label, recommended_order
...
def dashboard():
    ...
    recommended = [
        (a, score, priority_label(a, score, today), explain_priority(a, today))
        for a, score in recommended_order(incomplete, today, difficulty_weight=dw)
    ]
